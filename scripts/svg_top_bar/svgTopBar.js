var topBarSVG = (function () {
    var CONSTANTS = {
            ...
            TOP_BAR_MARGINS: 0.02,
            ICE_VS_FIRE_BAR_WIDTH_RATIO: 0.5,
            ICE_VS_FIRE_BAR_HEIGHT_RATIO: 0.5,
            BORDER_RADIUS: 8,
    ...
    function initialiseIceCubesCollected(paper, dimensions) {
        var iceCubeImage,
            iceCubeCountText,
            initialHeightAndWidth = dimensions.iceVsFireBarHeight,
            iceCubeImageX = dimensions.margin + (3 * dimensions.padding) + (4 * initialHeightAndWidth),
    ...
    function calculateTopBarDimensions(canvasWidth, canvasHeight) {
        var margin = canvasWidth * CONSTANTS.TOP_BAR_MARGINS,
            ...
            iceVsFireBarX = topBarWidth - margin - iceVsFireBarWidth - (2 * iceVsFireBarHeight);
    ...
    Object.defineProperty(topBarSVG, 'init', {
        value: function (containerID, canvasWidth, canvasHeight, timeON) {
            ...
            self._paper = initialiseSVGPaper(containerID, canvasWidth, canvasHeight);
